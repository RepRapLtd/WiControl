...
function Header()
{
   ...
   document.write('<ul>');
   document.write('<li><a href="sandb-heating-monday.php">Monday</a></li>');
	...
	document.write('<li><a href="sandb-heating-thursday.php"><big>Thursday <-</big></a></li>');
...
function Footer()
{
	...
	document.write('<br><button style="background-color:white" type="button" name="Save" onclick="SaveDay(NewFileToSave(), \'Thursday\', true)"><H2>Save</H2></button>');
...
var url2 = "../../sandb-profile-thursday.dat?timestamp=" + Date.now();

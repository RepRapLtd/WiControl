...
function Header()
{
   ...
   document.write('<li><a href="sandb-heating-monday.php">Monday</a></li>');
	...
	document.write('<li><a href="sandb-heating-sunday.php"><big>Sunday <-</big></a></li>');
...
function Footer()
{
	...
	document.write('<br><button style="background-color:white" type="button" name="Save" onclick="SaveDay(NewFileToSave(), \'Sunday\', true)"><H2>Save</H2></button>');
...
var url2 = "../../sandb-profile-sunday.dat?timestamp=" + Date.now();

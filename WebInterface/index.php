...
function Footer()
{
	...
	document.write('<br><button style="background-color:white" type="button" name="Save"><H2>Save</H2></button>');
	document.write('<button style="background-color:white" type="button" name="CopyWeek"><H2>Copy to weekdays</H2></button>');
	document.write('<button style="background-color:white" type="button" name="CopyWeekend"><H2>Copy to weekends</H2></button>');
	document.write('</form>');
}
...
function TableLine(tableLine, rowLength)
{
   ...
   var location = RoomName(tableLine);
	...
	document.write('<td align="center"><button style="background-color:yellow" type="button" name="' + location + 'Boost">Boost</button>  </td>');
   ...
   var temps = [];
	...
	document.write('<td align="center"><button style="background-color:yellow" type="button" name="' + location + 'Off">Off</button>  </td>');

...
function Header()
{
   ...
   document.write('<li><a href="sandb-heating-monday.php">Monday</a></li>');
	...
	document.write('<li><a href="sandb-heating-saturday.php"><big>Saturday <-</big></a></li>');
...
function Footer()
{
	...
	document.write('<br><button style="background-color:white" type="button" name="Save" onclick="SaveDay(NewFileToSave(), \'Saturday\', true)"><H2>Save</H2></button>');
...
var url2 = "../../sandb-profile-saturday.dat?timestamp=" + Date.now();
